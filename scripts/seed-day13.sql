-- Day 13: Communicating AI-Generated Work to Leadership
-- Week 3: Professional Communication & Impact

DELETE FROM curriculum_days WHERE program_id = '7da8d569-d5a3-47d8-9101-e8142b44822e' AND day_number = 13;
...
VALUES (
  ...
  13,
  'Communicating AI-Generated Work to Leadership',
  'Leaders do not want raw output. They want clarity.',
  '["Master the art of presenting AI-assisted work to senior stakeholders", "Learn to frame AI contributions without over-crediting or hiding them", "Develop executive communication skills for AI-enhanced deliverables", "Understand transparency as a trust-building strategy"]'::jsonb,
  'Leaders do not want raw output. They want clarity.'
);
...
BEGIN
  ...
  WHERE program_id = '7da8d569-d5a3-47d8-9101-e8142b44822e' AND day_number = 13;
