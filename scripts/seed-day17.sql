-- Day 17: Ethical Judgment in AI Environments
-- Week 4: Leadership & Career Acceleration

DELETE FROM curriculum_days WHERE program_id = '7da8d569-d5a3-47d8-9101-e8142b44822e' AND day_number = 17;
...
VALUES (
  ...
  17,
  'Ethical Judgment in AI Environments',
  'Speed without ethics creates risk.',
  '["Understand the ethical dimensions of AI-assisted work", "Learn to identify bias, fairness, and accountability issues in AI outputs", "Develop a personal ethical framework for professional decision-making", "Practice raising ethical concerns constructively in team settings"]'::jsonb,
  'Speed without ethics creates risk.'
);
...
BEGIN
  ...
  WHERE program_id = '7da8d569-d5a3-47d8-9101-e8142b44822e' AND day_number = 17;
