-- Day 7: Working Effectively with Humans + Machines
-- Week 2: Working with AI Systems

DELETE FROM curriculum_days WHERE program_id = '7da8d569-d5a3-47d8-9101-e8142b44822e' AND day_number = 7;
...
VALUES (
  ...
  7,
  'Working Effectively with Humans + Machines',
  'Your future teammates will include both people and intelligent systems.',
  '["Understand the dynamics of human-AI collaboration in the modern workplace", "Learn to leverage AI strengths while compensating for its limitations", "Develop workflows that maximize both human and machine contributions", "Build confidence in directing AI systems as a professional tool"]'::jsonb,
  'Your future teammates will include both people and intelligent systems.'
);
...
BEGIN
  ...
  WHERE program_id = '7da8d569-d5a3-47d8-9101-e8142b44822e' AND day_number = 7;
