-- Day 19: Influence Without Title
-- Week 4: Leadership & Career Acceleration

DELETE FROM curriculum_days WHERE program_id = '7da8d569-d5a3-47d8-9101-e8142b44822e' AND day_number = 19;
...
VALUES (
  ...
  '["Understand that influence is independent of organizational hierarchy", "Learn techniques for persuading peers and stakeholders without formal authority", "Develop the ability to lead through ideas, credibility, and collaboration", "Practice building coalitions and driving decisions from any position"]'::jsonb,
  'Leadership begins before authority.'
);
...
BEGIN
  ...
  WHERE program_id = '7da8d569-d5a3-47d8-9101-e8142b44822e' AND day_number = 19;
