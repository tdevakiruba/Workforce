-- Day 16: Reputation in Digital Workplaces
-- Week 4: Leadership & Career Acceleration

DELETE FROM curriculum_days WHERE program_id = '7da8d569-d5a3-47d8-9101-e8142b44822e' AND day_number = 16;
...
VALUES (
  ...
  16,
  'Reputation in Digital Workplaces',
  'Your reputation forms before your title does.',
  '["Understand how digital footprints shape professional reputation", "Learn to manage your professional brand across digital channels", "Identify the signals that build credibility in remote-first environments", "Develop intentional habits for reputation management"]'::jsonb,
  'Your reputation forms before your title does.'
);
...
BEGIN
  ...
  WHERE program_id = '7da8d569-d5a3-47d8-9101-e8142b44822e' AND day_number = 16;
