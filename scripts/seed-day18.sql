-- Day 18: Ownership Language & Executive Presence
-- Week 4: Leadership & Career Acceleration

DELETE FROM curriculum_days WHERE program_id = '7da8d569-d5a3-47d8-9101-e8142b44822e' AND day_number = 18;
...
VALUES (
  ...
  18,
  'Ownership Language & Executive Presence',
  'How you speak signals how ready you are to lead.',
  '["Understand how language patterns signal leadership readiness", "Learn to replace passive and tentative language with ownership language", "Develop executive presence in both written and verbal communication", "Practice speaking with authority while remaining collaborative"]'::jsonb,
  'How you speak signals how ready you are to lead.'
);
...
BEGIN
  ...
  WHERE program_id = '7da8d569-d5a3-47d8-9101-e8142b44822e' AND day_number = 18;
