...
DELETE FROM "wf-curriculum_days" WHERE program_id = '7da8d569-d5a3-47d8-9101-e8142b44822e' AND day_number = 2;

-- Insert Day 2
INSERT INTO "wf-curriculum_days" (program_id, day_number, title, theme, day_objective)
VALUES (
...
DECLARE
  ...
  v_section_id uuid;
BEGIN
  SELECT id INTO v_day_id FROM "wf-curriculum_days"
  WHERE program_id = '7da8d569-d5a3-47d8-9101-e8142b44822e' AND day_number = 2;

  -- Section 1: Reality Mapping
  INSERT INTO "wf-curriculum_sections" (day_id, sort_order, section_type, title, content)
  VALUES (
  ...
  INSERT INTO "wf-curriculum_exercises" (section_id, sort_order, question, question_type, options, thinking_prompts)
  VALUES
  ...
  INSERT INTO "wf-curriculum_exercises" (section_id, sort_order, question, question_type)
  VALUES
