-- Day 15: Trust as Career Currency
-- Week 3: Professional Communication & Impact

DELETE FROM curriculum_days WHERE program_id = '7da8d569-d5a3-47d8-9101-e8142b44822e' AND day_number = 15;
...
VALUES (
  ...
  15,
  'Trust as Career Currency',
  'Trust accelerates careers faster than talent alone.',
  '["Understand trust as the most valuable professional asset", "Learn the behaviors that systematically build trust with colleagues and leadership", "Identify trust-eroding patterns and how to avoid them", "Develop a personal trust-building strategy for your career"]'::jsonb,
  'Trust accelerates careers faster than talent alone.'
);
...
BEGIN
  ...
  WHERE program_id = '7da8d569-d5a3-47d8-9101-e8142b44822e' AND day_number = 15;
