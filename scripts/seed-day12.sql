-- Day 12: Translating AI Output into Business Impact
-- Week 3: Professional Communication & Impact

DELETE FROM curriculum_days WHERE program_id = '7da8d569-d5a3-47d8-9101-e8142b44822e' AND day_number = 12;
...
VALUES (
  ...
  12,
  'Translating AI Output into Business Impact',
  'Output is not value. Interpretation creates value.',
  '["Learn to bridge the gap between AI output and business value", "Develop skills for translating technical insights into stakeholder language", "Practice creating business cases from AI-generated analysis", "Understand that your value lies in interpretation, not generation"]'::jsonb,
  'Output is not value. Interpretation creates value.'
);
...
BEGIN
  ...
  WHERE program_id = '7da8d569-d5a3-47d8-9101-e8142b44822e' AND day_number = 12;
