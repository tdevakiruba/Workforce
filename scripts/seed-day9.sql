-- Day 9: Interpreting AI Output
-- Week 2: Working with AI Systems

DELETE FROM curriculum_days WHERE program_id = '7da8d569-d5a3-47d8-9101-e8142b44822e' AND day_number = 9;
...
VALUES (
  ...
  'AI generates answers. Professionals interpret them.',
  '["Develop critical evaluation skills for AI-generated content", "Learn to identify AI hallucinations, biases, and limitations", "Practice cross-referencing AI output with domain knowledge", "Build the habit of questioning before accepting AI recommendations"]'::jsonb,
  'AI generates answers. Professionals interpret them.'
);
...
BEGIN
  ...
  WHERE program_id = '7da8d569-d5a3-47d8-9101-e8142b44822e' AND day_number = 9;
