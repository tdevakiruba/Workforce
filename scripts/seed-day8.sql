-- Day 8: Prompting as a Professional Skill
-- Week 2: Working with AI Systems

DELETE FROM curriculum_days WHERE program_id = '7da8d569-d5a3-47d8-9101-e8142b44822e' AND day_number = 8;
...
VALUES (
  ...
  'The quality of your thinking determines the quality of AI output.',
  '["Understand prompting as a core professional competency, not a technical trick", "Learn structured prompt frameworks for workplace scenarios", "Practice crafting prompts that produce actionable, high-quality AI output", "Recognize that prompt quality reflects thinking quality"]'::jsonb,
  'The quality of your thinking determines the quality of AI output.'
);
...
BEGIN
  ...
  WHERE program_id = '7da8d569-d5a3-47d8-9101-e8142b44822e' AND day_number = 8;
