-- Day 14: Initiative in Hybrid Teams
-- Week 3: Professional Communication & Impact

DELETE FROM curriculum_days WHERE program_id = '7da8d569-d5a3-47d8-9101-e8142b44822e' AND day_number = 14;
...
VALUES (
  ...
  14,
  'Initiative in Hybrid Teams',
  'High performers do not wait for instruction.',
  '["Understand why initiative is the differentiator in hybrid and AI-augmented teams", "Learn to identify opportunities before they are assigned", "Develop proactive communication habits that signal leadership potential", "Build the confidence to act without waiting for permission"]'::jsonb,
  'High performers do not wait for instruction.'
);
...
BEGIN
  ...
  WHERE program_id = '7da8d569-d5a3-47d8-9101-e8142b44822e' AND day_number = 14;
