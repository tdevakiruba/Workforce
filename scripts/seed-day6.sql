-- Day 6: Reliability Builds Trust in Hybrid Teams
-- Week 2: Working with AI Systems

DELETE FROM curriculum_days WHERE program_id = '7da8d569-d5a3-47d8-9101-e8142b44822e' AND day_number = 6;
...
VALUES (
  ...
  6,
  'Reliability Builds Trust in Hybrid Teams',
  'Trust is built through consistency, not intelligence.',
  '["Understand why reliability is the foundation of professional trust", "Learn how hybrid teams (human + AI) depend on consistent human behavior", "Identify the behaviors that build and erode trust in remote and hybrid settings", "Develop a personal reliability standard for your first 90 days"]'::jsonb,
  'Trust is built through consistency, not intelligence.'
);
...
BEGIN
  ...
  WHERE program_id = '7da8d569-d5a3-47d8-9101-e8142b44822e' AND day_number = 6;
