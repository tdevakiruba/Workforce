-- Day 21: Capstone — AI Workforce Simulation
-- Week 4: Leadership & Career Acceleration

DELETE FROM curriculum_days WHERE program_id = '7da8d569-d5a3-47d8-9101-e8142b44822e' AND day_number = 21;
...
VALUES (
  ...
  21,
  'Capstone — AI Workforce Simulation',
  'From graduate to operator to trusted professional.',
  '["Demonstrate mastery of all program competencies in a realistic simulation", "Apply professional judgment, communication, and AI collaboration skills under pressure", "Complete the transformation from graduate mindset to professional operator", "Receive a comprehensive assessment of your readiness for the AI-powered workplace"]'::jsonb,
  'From graduate to operator to trusted professional.'
);
...
BEGIN
  ...
  WHERE program_id = '7da8d569-d5a3-47d8-9101-e8142b44822e' AND day_number = 21;
